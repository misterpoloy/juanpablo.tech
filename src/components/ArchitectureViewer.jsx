  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        ...
        <button onClick={onClose} style={{ background: "none", border: "none", color: "var(--ink4)", cursor: "pointer", fontSize: 19, padding: 0 }}>✕</button>
      </div>
...
export default function ArchitectureViewer({ architecture, iconMap, groupMeta: groupMetaProp }) {
  ...
  return (
    <div ref={ref} style={{ width: "100%", height: "100%", overflow: "hidden", position: "relative", background: "var(--bg)", fontFamily: "monospace", color: "var(--ink2)", userSelect: "none" }}
      ...
      {/* Header */}
      <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 52, zIndex: 50, background: "var(--overlay)", borderBottom: "1px solid var(--line)", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 16px", backdropFilter: "blur(12px)" }}>
